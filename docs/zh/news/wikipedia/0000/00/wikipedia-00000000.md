...
## 3 I/阿特拉斯   
3I/ATLAS, also known as C/2025 N1 (ATLAS) and previously as A11pl3Z, is an interstellar comet discovered by the Asteroid Terrestrial-impact Last Alert System (ATLAS) station. The comet follows an unbound, hyperbolic trajectory past the Sun. It will not come closer than 1.8 AU from Earth, so it poses no threat. It is the third interstellar object confirmed passing through the Solar System, after 1I/ʻOumuamua and 2I/Borisov, hence the prefix "3I". It is not expected to brighten enough to become visible in binoculars or to the naked eye. During solar conjunction on 21 October 2025, the comet could be observed by the GOES-19 weather satellite.   

3 I/ATLAS，也称为C/2025 N1（ATLAS），以前称为A11 pl 3 Z，是小行星撞击最后警报系统（ATLAS）站发现的一颗星际彗星。这颗彗星沿着一条不受约束的双曲线轨迹经过太阳。它与地球的距离不会超过1.8天文单位，因此不会构成威胁。它是确认穿过太阳系的第三个星际物体，仅次于1 I/ðOumuamua和2 I/Borisov，因此其后缀为“3 I”。预计它不会亮到足以在双筒望远镜或肉眼中可见。在2025年10月21日的太阳会合期间，GOES-19气象卫星可以观测到这颗彗星。   

阅读延伸[80340464]: [https://en.wikipedia.org/wiki/3I%2FATLAS](https://en.wikipedia.org/wiki/3I%2FATLAS)   
...
中式勺子或中式汤勺是一种勺子，手柄短而厚，直接从深而平的碗中伸出。它是中国美食中的常见器皿，用于盛放液体，尤其是汤，或散装固体食物。大多数由陶瓷制成。虽然通常用作餐具，但较大版本的中式勺子也用作上菜勺或勺子。该形状允许相同大小和设计的勺子相互堆叠以进行存储。   

阅读延伸[32605036]: [https://en.wikipedia.org/wiki/Chinese_spoon](https://en.wikipedia.org/wiki/Chinese_spoon)   
...
Abecedarium是由字母表中的字母组成的铭文，几乎总是按顺序列出。通常，基础是练习练习。   

阅读延伸[246773]: [https://en.wikipedia.org/wiki/Abecedarium](https://en.wikipedia.org/wiki/Abecedarium)   
...
## Grokipedia   
Grokipedia is an AI-powered online encyclopedia developed by xAI. An early beta version was launched on October 27, 2025. Entries in Grokipedia are created and edited by the Grok language model, but details of how it works are not currently known. Many articles are derived from Wikipedia articles, with some articles copied nearly verbatim at launch. Some articles carry a licensing notice as required by Wikipedia's Creative Commons Attribution-ShareAlike license. As of October 28, 2025, the site has about 900,000 articles.   

Grokipedia是xAI开发的一款人工智能驱动的在线百科全书。早期测试版于2025年10月27日推出。Grokipedia中的收件箱是由Grok语言模型创建和编辑的，但目前尚不清楚其工作方式的详细信息。许多文章源自维基百科文章，有些文章在发布时几乎逐字复制。某些文章带有维基百科知识共享归因-类似分享许可证要求的许可通知。截至2025年10月28日，该网站已有约90万篇文章。   

阅读延伸[81225342]: [https://en.wikipedia.org/wiki/Grokipedia](https://en.wikipedia.org/wiki/Grokipedia)   
